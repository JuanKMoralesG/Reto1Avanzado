package com.example.reto1pizzeria.helper;
...
public class ProductDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_CANT = "cant";
    ...
    public void addProduct(Product product) {
        ...
        try {
            ...
            values.put(COLUMN_CANT, product.getCant());
    ...
    public List<Product> getAllProducts() {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            int cantIndex = cursor.getColumnIndex(COLUMN_CANT);

            if (idIndex != -1 && nameIndex != -1 && priceIndex != -1 && descriptionIndex !=-1 && cantIndex !=-1) {
                do {
                    ...
                    double cant = cursor.getDouble(cantIndex);

                    // Agregar producto a la lista
                    products.add(new Product(id,name,price,description,cant));
